...
namespace Updater
{
    public partial class UpdaterForm : Form
    {
        ...
        private void UpdaterForm_Load(object sender, EventArgs e)
        {
            ...
            do
            {
                // Check for any arctool processes running.
                processes = Process.GetProcessesByName("DeadRisingArcTool.exe");
                if (processes.Length > 0)
                {
                    // Display an error to the user.
                    MessageBox.Show("Please close all DeadRisingArcTool windows before continuing!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
