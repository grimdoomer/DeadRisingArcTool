    ...
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                string buildVersion = FileVersionInfo.GetVersionInfo(buildFolder + "DeadRisingArcTool.exe").FileVersion;
                ...
                string updateZipFile = string.Format("{0}DeadRisingArcTool_{1}_{2}.zip", buildFolder, buildVersion, buildFlavor);
